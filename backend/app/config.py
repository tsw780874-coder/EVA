...
class Settings(BaseSettings):
    ...
    # 1. DeepSeek V4 Pro (主力高精度模型)
    deepseek_api_key: str = ""
    deepseek_model: str = "deepseek-v4-pro"
    deepseek_base_url: str = "https://api.deepseek.com"

    # 2. DeepSeek V4 Flash (主力快速模型)
    deepseek_flash_api_key: str = ""
    deepseek_flash_model: str = "deepseek-v4-flash"
    deepseek_flash_base_url: str = "https://api.deepseek.com"
    ...
    # 10. Gemini 1.5 Flash (主力快速多模态模型)
    gemini_flash_api_key: str = ""
    gemini_flash_model: str = "gemini-1.5-flash"
    gemini_flash_base_url: str = "https://generativelanguage.googleapis.com/v1beta/openai"

    # 11. Gemini 1.5 Pro (主力高精度多模态模型)
    gemini_pro_api_key: str = ""
    gemini_pro_model: str = "gemini-1.5-pro"
    gemini_pro_base_url: str = "https://generativelanguage.googleapis.com/v1beta/openai"

    # ============ 电商平台联盟 API 凭据 ============
    # 京东联盟 (JD Union Affiliate) — https://union.jd.com
    jd_union_app_key: str = ""
    jd_union_app_secret: str = ""
    jd_union_site_id: str = ""

    # 淘宝客 (Taobao Alliance) — https://pub.alimama.com
    taobao_app_key: str = ""
    taobao_app_secret: str = ""
    taobao_adzone_id: str = ""

    # 多多客 (Pinduoduo Duoduo Alliance) — https://open.pinduoduo.com
    pdd_client_id: str = ""
    ...
    def llm_config(self) -> dict:
        ...
        providers = {
            ...
            "deepseek_flash": {"api_key": self.deepseek_flash_api_key, "base_url": self.deepseek_flash_base_url, "model": self.deepseek_flash_model},
            ...
            "gemini_flash": {"api_key": self.gemini_flash_api_key, "base_url": self.gemini_flash_base_url, "model": self.gemini_flash_model},
            "gemini_pro": {"api_key": self.gemini_pro_api_key, "base_url": self.gemini_pro_base_url, "model": self.gemini_pro_model},
    ...
    # ============ 上下文管理配置 ============
    max_history_messages: int = 20              # 历史消息上限（条数）
    max_context_tokens: int = 4000             # 上下文最大 token 数
    context_summary_trigger_tokens: int = 3000 # 触发摘要压缩的 token 阈值
